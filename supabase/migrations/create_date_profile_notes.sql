-- =====================================================
-- CREATE DATE PROFILE NOTES TABLES
-- =====================================================
...
-- =====================================================
-- SEED DEFAULT FOLDERS (OPTIONAL)
-- =====================================================
-- Uncomment to create default folders for existing profiles
-- This is optional - folders can be created by users as needed

/*
INSERT INTO date_profile_note_folders (profile_id, name, color, order_index)
SELECT 
  id as profile_id,
  folder_name,
  folder_color,
...
LATERAL (VALUES
  ('Important', 'pink', 0),
  ('Preferences', 'yellow', 1),
  ('Interests', 'blue', 2),
  ('Reminders', 'green', 3),
  ('Ideas', 'orange', 4),
  ('Personal', 'purple', 5)
) AS folders(folder_name, folder_color, folder_order)
